...
/**
 * DatosHorarioId generated by hbm2java
 */
public class DatosHorarioId implements java.io.Serializable {

	private int codEstacion;
	private Date fecha;
	private Date hora;

	public DatosHorarioId() {
	}

	public DatosHorarioId(int codEstacion, Date fecha, Date hora) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DatosHorarioId))
			return false;
		DatosHorarioId castOther = (DatosHorarioId) other;
