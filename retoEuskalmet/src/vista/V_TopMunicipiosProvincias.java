...
public class V_TopMunicipiosProvincias extends JPanel {
	...
	public static JList list, list2, list3;

	private final String COD_BIZKAIA = "48";
	private final String COD_GIPUZKOA = "20";
	private final String COD_ARABA = "1";
	...
	public V_TopMunicipiosProvincias() {
		...
		getTopMunicipiosProvincia(COD_BIZKAIA, model1);
		...
		getTopMunicipiosProvincia(COD_GIPUZKOA, model2);
		...
		getTopMunicipiosProvincia(COD_ARABA, model3);
	...
	private void getTopMunicipiosProvincia(String codProvincia, DefaultListModel model) {
		try {

			iniciar();
			String operacionParams = null;
			switch (codProvincia) {
			case COD_BIZKAIA:
				operacionParams = "topMunicipiosProvincia~" + COD_BIZKAIA;
				break;
			case COD_GIPUZKOA:
				operacionParams = "topMunicipiosProvincia~" + COD_GIPUZKOA;
				break;
			case COD_ARABA:
				operacionParams = "topMunicipiosProvincia~" + COD_ARABA;
				break;
			}
			...
			for (int i = 0; i < response.size(); i++) {
				...
				model.addElement((i + 1) + ". " + response.get(i).getNombre() + "\n");
